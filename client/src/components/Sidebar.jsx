...
const menuItems = [
  ...
  return (
    <div className="w-72 min-h-screen bg-white dark:bg-slate-950 border-r border-black/10 dark:border-white/10 text-black dark:text-white flex flex-col justify-between transition-colors duration-300">
      ...
      {/* USER CARD */}
      <div className="p-4">
        <div className="bg-slate-100 dark:bg-white/5 border border-white/10 rounded-3xl p-5">
          ...
          <button
            ...
            className="mt-5 w-full bg-red-500 hover:bg-red-400 transition py-3 rounded-2xl font-semibold"
          >
            Logout
          </button>
        </div>

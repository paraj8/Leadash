...
/*import harshImg from ".src/assets/harsh.jpg";*/
export default function HarshRaj() {
  return (
      ...
      <div className="max-w-3xl w-full bg-slate-900 p-10 rounded-3xl border border-white/10">
        <div className="flex flex-col items-center">
          ...
          <p className="text-slate-300 text-center leading-relaxed">
            Works on frontend development, feature implementation, and testing of his platform.
          </p>
          <a
            href="/"

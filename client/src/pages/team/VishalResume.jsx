...
export default function VishalResume() {
  return (
    <div className="bg-slate-950 text-white">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-6 text-center">
        ...
        <p className="text-cyan-400 text-xl md:text-2xl mb-6">
          Computer Science Student | Frontend Developer | Video Editor
        </p>

        <p className="max-w-2xl text-slate-300">
          I build modern websites, create engaging digital content,
        ...
        <div className="flex gap-4 mt-8">
          ...
          <a
            href="https://vishal1pramanik.github.io/My-Resume/"
            target="_blank"
            rel="noreferrer"
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <p className="text-slate-300 text-center max-w-3xl mx-auto leading-relaxed">
          I'm Vishal Pramanik, a Computer Science student passionate
      ...
      <section className="py-24 px-6 bg-slate-900">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-slate-800 p-6 rounded-2xl">
            ...
            <p className="text-slate-400 mt-2">
              Creating engaging content and social media videos.
            </p>
          </div>
      ...
      <section className="py-24 px-6">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h3 className="text-2xl font-bold mb-3">
            Bachelor of Computer Science / Commerce 💼💰📈
          </h3>
      ...
      <section className="py-24 px-6 bg-slate-900">
        ...
        <div className="text-center space-y-4">
          <p>GitHub: github.com/Vishal1Pramanik</p>
          <a href="www.linkedin.com/in/vishal-pramanik-935b592ab">
          <p>LinkedIn: Vishal Pramanik</p>
          </a>
        </div>
      </section>
